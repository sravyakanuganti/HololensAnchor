...
public class MarkerPositions : MonoBehaviour
{
    ...
    private void load_matrices()
    {
        try
        {
            ...
            crossMark1Transform = new Vector3(-0.621011f, -1.22434f, 2.77239f);
            ...
            crossMark2Transform = new Vector3(-0.411577f, -1.23976f, 2.23905f);
            ...
            crossMark3Transform = new Vector3(-0.877903f, -1.23081f, 1.95112f);
            ...
            crossMark4Transform = new Vector3(-0.985315f, -1.2414f, 2.59784f);
            ...
            crossMark5Transform = new Vector3(-0.533436f, -1.86067f, 2.68916f);
            ...
            crossMark6Transform = new Vector3(-0.961086f, -1.88846f, 2.57747f);
    ...
    public void Start()
    {
        ...
        _crossmarks = GameObject.Find("MarkerPositions");
        if (_crossmarks == null)
        {
